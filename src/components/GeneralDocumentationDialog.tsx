      ...
      <div className="shrink-0 border-b border-border bg-card px-4 py-4 sm:px-6 sm:py-5">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="text-xl font-semibold text-foreground sm:text-2xl">General Documentation</div>
            <div className="mt-1.5 text-sm text-muted-foreground">General information about Liquid syntax and usage</div>
          </div>
        </div>
          ...
          <Section id="general-introduction" title="Introduction to Liquid" icon={<BookOpen className="h-6 w-6" />}>
            <div className="rounded-lg border border-border bg-muted/40 p-4">
              <p className="text-sm text-muted-foreground">
                Liquid is a template language created by Shopify and written in Ruby. It is now used by many systems,
                including Jekyll, a static site generator. Liquid uses a combination of tags, objects, and filters to
      ...
      <DialogContent className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="flex h-[min(85dvh,720px)] w-full max-w-3xl flex-col overflow-hidden rounded-xl border border-border bg-card shadow-xl">
          <div className="flex items-center justify-between border-b border-border bg-card px-4 py-3 sm:px-6">
            <DialogTitle className="text-lg font-semibold text-foreground sm:text-xl">Documentation</DialogTitle>
            <Button
              variant="ghost"
              size="icon"
